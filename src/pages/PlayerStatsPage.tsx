...
import { ArrowDown, ArrowUp, Download, FileSpreadsheet, ImagePlus, Plus, Search, Save, Trash2, Upload, Users, X } from 'lucide-react';
...
function PlayerStatsPage({ onPlayerClick }: { onPlayerClick?: (playerId: string) => void }) {
  ...
  const handleImageSelect = (url: string) => { setForm((current) => ({ ...current, image_url: url })); };
